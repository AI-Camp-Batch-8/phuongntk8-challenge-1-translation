...
nohup nice ~/moses/scripts/training/train-model.perl -root-dir train -corpus $root_dir/corpus/train.clean -f vi -e en -alignment grow-diag-final-and -lm 0:4:$root_dir/lm/language-model.blm.en:8 -external-bin-dir ~/moses/training-tools/ -mgiza -mgiza-cpus 2 >& training.out & #-cores 4
